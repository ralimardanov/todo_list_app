...
settings = {
    # if it's a file or a directory, path will be like this - ../../
    "prod": "settings.prdsettings.PRDsettings",
    "dev": "settings.devsettings.DEVsettings",
    "test": "settings.testingsettings.Testsettings"
}
...
def get_settings(settings_name):
    ...
    raise Exception("Setting name you select %s isn't supported" %
                    settings_name)
...
def create_app(settings_name):
    ...
    # this loads the config from the settings_obj. also can be loaded from_envvar
